...
export const Footer = () => {
  return (
    <div className="bg-[#4338CA] w-full h-[280px] py-[40px] flex justify-center items-center">
      <div className=" flex gap-[120px] justify-between w-[1280px] h-[200px]">
        <div className="flex flex-col gap-3">
          <div className="flex gap-2  items-center text-[#FAFAFA] text-sm italic font-bold leading-[20px] tracking-[0.32px] cursor-pointer">
            <MovieZWhiteIcon />
            Movie Z
          </div>
